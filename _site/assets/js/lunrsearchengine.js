...
var documents = [{
    ...
    "title": "404",
    "body": "404 Страница не найдена!Пожалуйста, используйте панель поиска слева внизу или перейдите на главную страницу! "
    }, {
    "id": 1,
    "url": "http://localhost:4000/jekyll-theme-memoirs/about",
    "title": "Создано для ежедневных заметок и планирования задач",
    "body": "Этот сайт работает как дневник для повседневных записей и ориентир по поставленным целям и задачам. Изначально предусмотрено что записи могут вести Денис, Аурика и Никита.  О чём идет речь → "
    }, {
    "id": 2,
    ...
    "body": "  Пожалуйста, отправьте ваше сообщение Denis-Aurica-Nikita. Мы ответим как можно скорее!   "
    }, {
    "id": 4,
    "url": "http://localhost:4000/jekyll-theme-memoirs/",
    "title": "Home",
    "body": "                                                                                               Руководство с примерами по написанию постов на Jekyll markdown              :       Заголовки:                                                                               Денис                 25Июня 2020                                                                                                                           Идеи по поводу запуска интернет магазина                         1 2 3 4 5                      :       Для того чтобы запустить интернет магазин нужен дополнительный опыт. Для этого нужно посмотреть обучающее руководство - точную пошаговую инструкцию. Лучше бы чтобы этот магазин был в США - поэтому руководство. . . :                                                                               Денис                 21Июня 2020                                                                                                                           Much more than a desert: A trip into the Sahara              :       The Sahara is a desert located on the African continent. It is the largest hot desert in the world, and the third largest desert overall after Antarctica and the Arctic. . . . :                                                                               Никита                 1Февраля 2020                                                                                                                           One day we just started our adventure              :       The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. :                                                                               Денис                 12Января 2020                                                                                                                           London is that kind of place you must visit in this lifetime              :       The Queen’s Guard and Queen’s Life Guard (called King’s Guard and King’s Life Guard when the reigning monarch is male) are the names given to contingents of infantry and cavalry. . . :                                                                               Денис                 12Января 2020                                                                                                                           Memoirs supports external images as featured              :       Adding images is a very annoying task, I know that, but “Memoirs” theme has external featured images integrated so your publishing task becomes easier now. :                                                                               Никита                 12Января 2020                                   &laquo;        1        2        3       &raquo; "
    }, {
    "id": 5,
    ...
    "id": 7,
    "url": "http://localhost:4000/jekyll-theme-memoirs/page3/",
    "title": "Home",
    "body": "  {% for post in paginator. posts %}    {% include postbox. html %}  {% endfor %}  {% include pagination. html %}"
    }, {
    "id": 8,
    "url": "http://localhost:4000/jekyll-theme-memoirs/jekyll-post-tutorial/",
    "title": "Руководство с примерами по написанию постов на Jekyll markdown",
    "body": "2020/06/25 - Заголовки: Заголовок первого уровня========================Заголовок второго уровня-------------------------# Заголовок первого уровня### Заголовок третьего уровня###### Заголовок шестого уровня# Заголовок первого уровня #### Заголовок третьего уровня ######### Заголовок шестого уровня ######Цитаты: &gt; Первый уровень цитирования&gt;&gt; Второй уровень цитирования&gt;&gt;&gt; Третий уровень цитирования&gt;&gt;Первый уровень цитированияСписки: * Проводник+ Полупроводник- Диэлектрик1. Проводник2. Полупроводник3. ДиэлектрикГоризонтальные: Первая часть текста, который необходимо разделить***Вторая часть текста, который необходимо разделитьПервая часть текста, который необходимо разделить-- -- - -- --- Вторая часть текста, который необходимо разделитьСсылки: [название](http://example. com/  Необязательная подсказка при наведении )&lt;http://example. com/&gt;В результате на экран выводится следующее: http://example. com/ &lt;address@example. com&gt;Локальные сноски по id [название] [id]:В этом случае возможно определить идентификатор в любом месте документа [id]: http://example. com/  Необязательная подсказка Выделение: *курсив*_курсив_**полужирный**__полужирный__***полужирный курсив***___полужирный курсив___Изображения: ![Альтернативный текст](/путь/к/изображению. jpg  Необязательная подсказка )![Альтернативный текст][id][id]: путь/к/изображению  Необязательная подсказка Квадратные скобки, в которых указывается альтернативный изображению текст (он станет содержимым атрибута в элементе img) Markdown не позволяет задать размеры изображения (ширину, высоту) Обратный слеш: Может употребляться в Markdown перед специальными символами для того, чтобы они воспринимались в их буквальном (а не служебном) значении. "
    }, {
    "id": 9,
    "url": "http://localhost:4000/jekyll-theme-memoirs/start-internet-store/",
    "title": "Идеи по поводу запуска интернет магазина",
    "body": "2020/06/21 - Для того чтобы запустить интернет магазин нужен дополнительный опыт. Для этого нужно посмотреть обучающее руководство - точную пошаговую инструкцию. Лучше бы чтобы этот магазин был в США - поэтому руководство должно быть, желательно, по США. Или поучавствовать/поработать в таком-же проекте. А то, когда это стоит - нет никакого толку. Как будто бы зависло/застряло. Проект должен жить.  Здесь немного позже допишу. Какие варианты удалось найти для развития проекта и составлю план. Сейчас ищу на “отборных сливах”, по торрентам и youtube. Гуглить еще и википедия. Объявления о трудоустройстве. Ещё очень полезно будет найти похожих торгашей/продавцов может быть посмотреть на форумах и в сообществах телеграмм. Круг общения нужен. "
    }, {
    "id": 10,
